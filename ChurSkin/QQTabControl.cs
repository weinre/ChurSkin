...
{ /// <summary>
    ...
    {
        #region 变量
        private Image _titleBackground = AssemblyHelper.GetImage("QQ.AppFramework.TabControl.tabctrl_bkg.png");
        ...
        {
            if (m.Msg != (int)Win32.WindowsMessage.WM_CONTEXTMENU)//0x007B鼠标右键
            {
                base.WndProc(ref m);
            }
        }
